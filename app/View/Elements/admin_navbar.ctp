...
<ul class="nav navbar-nav navbar-right">
    ...
    <!--<li><?php echo $this->Html->link('<i class="desktop glyphicon glyphicon-refresh"></i>'.' <span class="mobile">'.__('Import').'</span>', array('controller' => 'songs', 'action' => 'import'), array('data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => __('Database update'), 'class' => 'nav-tooltips', 'escape' => false)); ?></li>-->
    <li><?php echo $this->Html->link('<i class="desktop glyphicon glyphicon-cog"></i>'.' <span class="mobile">'.__('Settings').'</span>', array('controller' => 'settings', 'action' => 'index'), array('data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => __('Settings'), 'class' => 'nav-tooltips', 'escape' => false)); ?></li>
    <li><?php echo $this->Html->link('<i class="desktop glyphicon glyphicon-user"></i>'.' <span class="mobile">'.__('Users').'</span>', array('controller' => 'users', 'action' => 'index'), array('data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => __('Users'), 'class' => 'nav-tooltips', 'escape' => false)); ?></li>
